                                                ...
                                                <table class="table table-nowrap table-hover align-middle mb-0">
                                                   <thead>
                                                      <tr>
                                                         ...
                                                         <th data-priority="1" id="tech-companies-1-col-1">Client</th>
                                                         <th data-priority="1" id="tech-companies-1-col-1">Assignee</th>
                                                      ...
                                                      <tr>
                                                         <td>
                                                            <div class="table-task">
                                                               <span class="text-truncate font-size-13 mb-0 fw-bold"> <i class="mdi mdi-check-circle-outline"></i> Task name</span>
                                                            </div>
                                                         </td>
                                                         <td>
                                                            <div class="table-task">
                                                               <span class="text-truncate font-size-13 mb-0 fw-light">Client name / Company name</span>
                                                            </div>
                                                         </td>
                                                         <td>
                                                            <div class="table-task">
                                                      ...
                                                      <div class="avatar-group">
                                                         ...
                                                         <td>
                                                            <div class="table-task">
                                                               <!-- <h5 class="text-truncate font-size-13 mb-0"><a href="#" class="text-dark">Priority</a></h5> -->
                                                               <div class="d-flex gap-2">
                                                                  <span class="badge rounded-pill bg-warning font-size-11 text-white">Medium</span>
                                                               </div>
                                                            </div>
                                                         </td>
                                                         <td class="text-muted fw-light">Not started</td>
                                                      ...
                                                      <div class="avatar-group">
                                                         ...
                                                         <td>
                                                            <div class="table-task">
                                                               <!-- <h5 class="text-truncate font-size-13 mb-0"><a href="#" class="text-dark">Priority</a></h5> -->
                                                               <div class="d-flex gap-2">
                                                                  <span class="badge rounded-pill bg-success font-size-11 text-white">Low</span>
                                                               </div>
                                                            </div>
                                                         </td>
                                                         <td class="text-muted fw-light">Not started</td>
...
<!-- END layout-wrapper -->
<!-- Right Sidebar -->
<?php include 'layouts/new-task.php'; ?>
